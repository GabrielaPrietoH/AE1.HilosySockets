...
public class Cliente {
	...
	public static final String IP_SERVER = "localhost";
		...
		//Cambios Gabriela 
						...
						String[] peliculasRecibidas = directorPeli.split("\\|"); // Escapamos el carácter | porque es especial en expresiones regulares
						...
						String[] peliculas = new String[] {id, nombre, director, precio};

						peliculas = respuesta.split("\\|"); // Escapamos el carácter | porque es especial en expresiones regulares

						for (String pelicula : peliculas) {
						    System.out.println(pelicula);
						}
						 salida.println("Pelicula añadida al array : " + peliculas); 
