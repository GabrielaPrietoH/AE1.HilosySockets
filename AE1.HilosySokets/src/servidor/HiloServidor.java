...
import java.util.List;
	...
	public class HiloServidor implements Runnable {
		...
		private static void addPeliculas(StringBuilder acumulador1) {
			...
			try {
				...
				// Cambios Gabriela 		
					...
					case "4":
						...
						//recibo elección entre ellas
						String respuesta4 = eB.readLine();
						//**Envío múltiples elecciones con un delimitador.
						StringBuilder acumulador1 = new StringBuilder();
						for(Peliculas pelicula : peliculas){
							if(pelicula.getDirector().toLowerCase().contains(respuesta4.toLowerCase())){
								acumulador1.append(pelicula.toString()).append("|");
							}
						}
						addPeliculas(acumulador1);
						salida.println(acumulador1.toString());
